                ...
                <Col md={4}>
                    <blockquote class="relative">
                        ...
                        <footer class="mt-6">
                            ...
                            <div class="ml-4">
                                <div class="text-base font-semibold text-gray-800 dark:text-gray-400">Viviane Menezes</div>
                                <div class="text-xs text-gray-500">Fisioterapeuta</div>
                            </div>
                            </div>
                        </footer>
                    </blockquote>
                ...
                <Col md={4}>
                    <blockquote class="relative">
                            ...
                            <footer class="mt-6">
                                ...
                                <div class="ml-4">
                                    <div class="text-base font-semibold text-gray-800 dark:text-gray-400">Letícia Costa</div>
                                    <div class="text-xs text-gray-500">Fisioterapeuta</div>
                                </div>
                                </div>
                            </footer>
                ...
                <Col md={4}>
                    <blockquote class="relative">
                            ...
                            <footer class="mt-6">
                                ...
                                <div class="ml-4">
                                    <div class="text-base font-semibold text-gray-800 dark:text-gray-400">Hugo Jorge</div>
                                    <div class="text-xs text-gray-500">Fisioterapeuta</div>
                                </div>
                                </div>
                            </footer>
