  ...
  return (
    <>
      <Container fluid className="mainTeam">
        ...
        <C.SubTitleTop>
          Nosso time é composto por sócios especializados na área de tecnologia
        </C.SubTitleTop>
        <Row>
          <Col>
            <Card
            ...
            >
              ...
              <Card.Body>
                ...
                <C.Text>Analista e desenvolvedor Full-Stack</C.Text>
                ...
                <C.CardIcon>
                  ...
                  <C.LinkA
                    href="https://www.linkedin.com/in/john-kevin-3ba351184/"
                    target="_blank"
                  >
                    <BsLinkedin size={32} />
                  </C.LinkA>
                  ...
                  <C.LinkA
                    href="https://github.com/kev1nnnnnnn"
                    target="_blank"
                    size={32}
                  >
                    <BsGithub size={32} />
          ...
          <Col>
            ...
            >
              ...
              <Card.Body>
                ...
                <C.Text>Desenvolvedor Front End UI/UX</C.Text>
                <C.CardIcon>
                  <OverlayTrigger
                    placement="bottom"
                    delay={{ show: 25, hide: 400 }}
                  ...
                  <C.LinkA
                    href="https://www.linkedin.com/in/juliam-reis/"
                    target="_blank"
                  >
                    <BsLinkedin size={32} />
                  </C.LinkA>
                  ...
                  <C.LinkA
                    href="https://github.com/Julianreiss"
                    target="_blank"
                    size={32}
                  >
                    <BsGithub size={32} />
          ...
          <Col>
            ...
            >
              ...
              <Card.Body>
                <C.Title>Matheus Oliveira</C.Title>
                <C.Text>Desenvolvedor Back-End, Cloud Computing</C.Text>
                <C.CardIcon>
                  <OverlayTrigger
                    placement="bottom"
                    delay={{ show: 25, hide: 400 }}
                  ...
                  <C.LinkA
                    href="https://www.linkedin.com/in/matheus-oliveira-67372816a/"
                    target="_blank"
                  >
                    <BsLinkedin size={32} />
                  </C.LinkA>
                  ...
                  <C.LinkA
                    href="https://github.com/matheusmoliveira"
                    target="_blank"
                    size={32}
                  >
                    <BsGithub size={32} />
