        ...
        <Container className='mainContact'>
            ...
            <Row>
                ...
                <Col md={6}>
                    ...
                    <C.Text>Ficou interessado no meu trabalho? Ótimo, fique a vontade de me mandar uma mensagem por WhatsApp e solicitar o seu orçamento, assim poderei te ajudar da melhor maneira possível!</C.Text>
                    <OverlayTrigger
                    placement="right"
